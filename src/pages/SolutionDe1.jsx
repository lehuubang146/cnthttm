    ...
    <div style={{ padding: '2rem 0' }}>
      ...
      <section style={{ marginTop: '2rem' }}>
        ...
        <div style={solutionBlock}>
          ...
          <p style={{ paddingLeft: '1rem', fontStyle: 'italic', marginBottom: '0.5rem' }}>Công thức khoảng cách: <span style={codeStyle}>d = <span style={{ whiteSpace: 'nowrap' }}>√<span style={{ borderTop: '1px solid #0f172a', paddingTop: '1px' }}>((x1 - x2)² + (y1 - y2)²)</span></span></span></p>
          <ul style={{ listStyleType: 'none', paddingLeft: '1rem', lineHeight: '2' }}>
            <li>• <strong>KH1 (0.0833, 0.6):</strong> d = <span style={{ whiteSpace: 'nowrap' }}>√<span style={{ borderTop: '1px solid #334155', paddingTop: '1px' }}>((0.4167 - 0.0833)² + (0.6 - 0.6)²)</span></span> ≈ 0.3334 → <strong>Hạng 2</strong> (No)</li>
            <li>• <strong>KH2 (0.8333, 1.0):</strong> d = <span style={{ whiteSpace: 'nowrap' }}>√<span style={{ borderTop: '1px solid #334155', paddingTop: '1px' }}>((0.4167 - 0.8333)² + (0.6 - 1.0)²)</span></span> ≈ 0.5775 → <strong>Hạng 3</strong> (Yes)</li>
            <li>• <strong>KH3 (0.2500, 0.0):</strong> d = <span style={{ whiteSpace: 'nowrap' }}>√<span style={{ borderTop: '1px solid #334155', paddingTop: '1px' }}>((0.4167 - 0.2500)² + (0.6 - 0.0)²)</span></span> ≈ 0.6227 → <strong>Hạng 5</strong> (No)</li>
            <li style={{ color: '#16a34a', fontWeight: '500', backgroundColor: '#f0fdf4', padding: '0.2rem 0.5rem', borderRadius: '4px' }}>• <strong>KH4 (0.5833, 0.8):</strong> d = <span style={{ whiteSpace: 'nowrap' }}>√<span style={{ borderTop: '1px solid #16a34a', paddingTop: '1px' }}>((0.4167 - 0.5833)² + (0.6 - 0.8)²)</span></span> ≈ 0.2603 → <strong>Hạng 1</strong> (Yes)</li>
            <li>• <strong>KH5 (0.0000, 1.0):</strong> d = <span style={{ whiteSpace: 'nowrap' }}>√<span style={{ borderTop: '1px solid #334155', paddingTop: '1px' }}>((0.4167 - 0.0000)² + (0.6 - 1.0)²)</span></span> ≈ 0.5776 → <strong>Hạng 4</strong> (No)</li>
            <li>• <strong>KH6 (1.0000, 0.2):</strong> d = <span style={{ whiteSpace: 'nowrap' }}>√<span style={{ borderTop: '1px solid #334155', paddingTop: '1px' }}>((0.4167 - 1.0000)² + (0.6 - 0.2)²)</span></span> ≈ 0.7072 → <strong>Hạng 6</strong> (Yes)</li>
          </ul>
